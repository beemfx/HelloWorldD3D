...
#include "HWD3DMesh_DX7.h"
#include "HWD3DGame_DX7.h"

HWD3DMesh* HWD3DMesh::CreateMesh(class HWD3DGame* InGame, const char* InFilename)
{
	return new HWD3DMesh_DX7(dynamic_cast<HWD3DGame_DX7*>(InGame), InFilename);
}

void HWD3DMesh_DX7::Draw()
{
...
HWD3DMesh_DX7::HWD3DMesh_DX7(class HWD3DGame_DX7* InGame, const char* InFilename)
	: m_Game(InGame)
{
...
HWD3DMesh_DX7::~HWD3DMesh_DX7()
{
	HWD3D_SafeRelease(m_VB);
}

bool HWD3DMesh_DX7::CreateBuffers()
{

...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR    lpCmdLine, _In_ int       nCmdShow)
{
	...
	// Create Main Window
	{
		...
		MainWnd = CreateWindowW(WinMain_WindowClass, szTitle, WS_CAPTION|WS_SYSMENU|WS_MINIMIZEBOX, CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, nullptr, nullptr, hInstance, nullptr);
	...
	Game.Init(MainWnd, RcClient.right - RcClient.left , RcClient.bottom - RcClient.top );

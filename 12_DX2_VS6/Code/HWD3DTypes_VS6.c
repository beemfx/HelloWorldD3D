...
{
	const hwd3d_vec3 D = HWD3DVec3_Subtract(LookAtPos, EyePos);
	const hwd3d_vec3 ZAxis = HWD3DVec3_GetNormalized(&D);
	const hwd3d_vec3 C = HWD3DVec3_Cross(UpDir, &ZAxis);
	const hwd3d_vec3 XAxis = HWD3DVec3_GetNormalized(&C);

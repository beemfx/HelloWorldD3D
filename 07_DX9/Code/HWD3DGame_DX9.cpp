...
{
	SetWindowTextW(InMainWnd, L"Hello World D3D [DX9]");

	HWD3DGame* Out = new HWD3DGame_DX9;
	if (Out)
	{
		Out->Init(InMainWnd);
	}
...
void HWD3DGame_DX9::InitDevice(HWND TargetWnd)
{
...
void HWD3DGame_DX9::DeinitDevice()
{
...
void HWD3DGame_DX9::ClearViewport()
{
	if (m_D3DDevice)
	{
...
void HWD3DGame_DX9::SetTransformMatrix(hwd3d_transform_t InType, const hwd3d_matrix& InMatrix)
{
	if (m_D3DDevice)
	{
